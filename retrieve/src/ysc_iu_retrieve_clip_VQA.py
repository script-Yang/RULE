...
from training.data import HarvardDataset,HarvardVQADataset, RadiologyDataset, IUXrayVQADataset, IUXrayDataset
import debugpy
...
def main(args):
    ...
    with torch.no_grad(), torch.cuda.amp.autocast():
        for batch in tqdm(train_dataloader, desc="Extracting traininig features"):
            # images, texts, image_full_paths, _, _ = batch
